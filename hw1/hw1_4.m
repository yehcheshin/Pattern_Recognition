...
S1=[7 4;4 5];%covariance matrices S1
m2=[10;5];%mean vector:m2
S2=[7 4;4 5];%covariance matrices S2
m3=[11;1];%mean vector:m3
S3=[7 4;4 5];%covariance matrices S3
...
%data(X4 data): Nx2 :N筆1x2維的data座標
...
bayesian_g1 = Bayesian_classifier(m1,S1,P,X4);
bayesian_g2 = Bayesian_classifier(m2,S2,P,X4);
bayesian_g3 = Bayesian_classifier(m3,S3,P,X4);
bayesian_g = [bayesian_g1;bayesian_g2;bayesian_g3];

%3個classes Mahalanobis classifier's discrimintation function 結果
Mahalanobis_g1 = Mahalanobis_classifier(m1,S1,P,X4);
Mahalanobis_g2 = Mahalanobis_classifier(m2,S2,P,X4);
Mahalanobis_g3 = Mahalanobis_classifier(m3,S3,P,X4);
Mahalanobis_g = [Mahalanobis_g1;Mahalanobis_g2;Mahalanobis_g3];

%3個classes Euclidean classifier's discrimintation function 結果
Euclidean_g1 =  Euclidean_classifier(m1,S1,P,X4);
Euclidean_g2 =  Euclidean_classifier(m2,S2,P,X4);
Euclidean_g3 =  Euclidean_classifier(m3,S3,P,X4);
